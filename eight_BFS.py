...
def solvePuzzle_depth(srcLayout, destLayout):
    ...
    while len(stack_layouts) > 0:
        curLayout = stack_layouts.pop(0)  # 把栈改成队列#出栈
...
if __name__ == "__main__":
    ...
    srcLayout = input("请输入初始方阵：")
    destLayout = input("请输入目标方阵：")
    # srcLayout = "541203786"
    ...
    if retCode != 0:
        ...
        print("一共需要" + str(len(lst_steps)) + "步")

    print(time1)
    print(time2)


    print("搜索时长为", (time2 - time1).microseconds, "ms")
